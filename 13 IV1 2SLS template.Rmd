...
hiv = read_dta("nonparametricvct.dta")
...
fit6_2 = feols(data = hiv, subset = hiv$hadsex12 == 1, cluster == 'villnum', 
               got ~ any*male*hiv2004 + 
                 tinc*male*hiv2004 + I(tinc^2)*male*hiv2004 +
                 distvct*male*hiv2004 + I(distvct^2)*male*hiv2004 -
                 male:hiv2004 + age + I(age^2) + simaverage + rumphi)
```
...
fit7_4 = feols(numcond ~ hiv2004 + male + age + I(age^2) + simaverage + rumphi |
                 got + got_hiv ~ any*male*hiv2004 + 
                 tinc*male*hiv2004 + I(tinc^2)*male*hiv2004 +
                 distvct*male*hiv2004 + I(distvct^2)*male*hiv2004 -
                 male:hiv2004 - hiv2004 - male,
               data = hiv, 
               subset = hiv$hadsex12 == 1, 
               cluster = 'villnum')

# i think the instruments are the variables after tilda
# cragdonald test is 1st 'F-test (1st stage)' - is the first stage different from 0 from just predicting the average
...
feols(numcond ~ hiv2004 + male + age + I(age^2) + simaverage + rumphi |
               ...
               subset = hiv$hadsex12 == 1, 
               cluster = 'villnum')
# exclusion restriciton violation becuase instrument is a function of endogenous variable
```
