...
author: "Anahi Rodrigguez"
date: "Collaborated with Nicole"
output: 
  html_document:
    toc: yes
    # toc_float: true
...
**Answer:** No, the trend of points before and after the cutoff does not seem to be bunched; line is continous at cutoff of 0.5
...
**Answer:** I believed these variables are reasonably balanced apart from the most imbalance occurring at real income. The fitted lines and confidence intervals at least slightly overlap in all figures. 
...
etable(fitoutcomes, dict = tab_dict, se.below = T,
       fitstat = c("n", "r2"))
...
**Answer:** Voters elect but not effect policies
